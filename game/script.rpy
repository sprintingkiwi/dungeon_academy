...
label PART_1:
    ...
    label chapter_1:
        ...
        #         "Rogue's classroom" if (Player.location is not "Rogue's classroom"):
        #             $ visited.append("Rogue's classroom")

        # "Bathroom" if (Player.location is not "Bathroom"):
        #     call main_hall
        # "Arena" if (Player.location is not "Arena"):
        #     call main_hall
        # "Dining room" if (Player.location is not "Dining room"):
        #     call main_hall
        # "Exit the Academy" if (Player.location is not "City"):
        #     call city

        menu:
            "Go to Rogue's Classroom":
