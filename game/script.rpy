...
label PART_1:
    ...
    label chapter_1:
        ...
        "You will play the role of a student at the 'Dungeon Academy', the most prestigious academy for adventurers"
        ...
        "the Academy!"
        "You inhale deeply the fresh morning air as you scan the horizon. Yes, it's a beautiful day."
        "The best of all: your first day of academy."
        "You left early to avoid the risk of being late. In fact, waiting outside the academy would be a"
        "wonderful moment."
        "Will you perhaps meet future classmates there? Will they become friends and valuable allies for"
        "the years to come at the academy, or even lifelong adventure companions?"
        "As you think about these things, staring up at the sky, something trips you up and you fall"
        "heavily to the ground, your face smacked against the stone-paved path."
        c "Ahi!"
        ...
        c "Hehe, my fault, sorry! I'm a bit clumsy and I always end up dropping things..."
        c "I am Ciry, by the way..."
        p "Well, I'm "
        ...
        while len(test_taken) < 3:
            menu:
                ...
                "Take the Barbarian test" if "Barbarian" not in test_taken:
                    ...
                    dra "HAHAHA"
                    dra "HAHAHAHAHAHAHA!!!"
                    dra "But you are just skin and bones!"
    ...
    label chapter_2:
        ...
        c "Well, in theory one should believe in the guiding principles of a Deity, not worshipping just for recieve divine powers but... I guess that's more or less right, in practical terms"
